...
def fpn_classifier_graph(rois, feature_maps,
    ...
    # do not try to add layers here , it is very sensive . add more layers will decrease the accuracy heavily 
...
def build_fpn_mask_graph(rois, feature_maps,
    ...
    # Conv layers
    '''
    # change 5  use dropout for each layer 
    '''
    x = KL.TimeDistributed(KL.Conv2D(256, (3, 3), padding="same"),
                           name="mrcnn_mask_conv1")(x)
   # x= KL.TimeDistributed(KL.Dropout(0.5, noise_shape=None, seed=None))(x)
